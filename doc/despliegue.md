...
#### Consecuencias de ignorar  y proseguir:

Si continua sin incluir esta función, la VM anfitrión no podrá virtualizar otras VM.

   ### Diagnósticos del problema:

​       [Guía de soluciones para la virtualización anidada](/doc//virtualizacion-anidada-soluciones.md)
